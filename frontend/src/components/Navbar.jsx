...
export default function Navbar({ title = "Home", eyebrow = "OPERATIONS CENTER" }) {
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden text-right sm:block">
              <p className="text-sm font-semibold text-ink">Reception</p>
              <p className="text-xs text-muted">Hallmark Residences</p>
            </div>
